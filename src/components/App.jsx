...
var App = React.createClass({
  ...
  checkAnswer(userval) {
    if (
      parseInt(userval) === this.props.data.questions[this.state.questionno].ans
    ) {
      ...
      alert(
        "wrong answer \n" +
          this.props.data.questions[this.state.questionno].Options[
            this.props.data.questions[this.state.questionno].ans
          ]
      );
      // this.props.data.questions[this.state.questionno].ans
    }
    ...
    if (this.state.remain < 0) {
      return (
        <div>
          ...
          <a onClick={this.reset} className="btn btn-primary">
            Try Again
          </a>
      ...
      return (
        <div>
          ...
          <QuestionBox
            questionno={this.state.Qn}
            question={this.props.data.questions[this.state.questionno]}
          />
          <div className="row">
            <div className="col-sm-6"></div>
            <div className="col-sm-6">
              <a className="btn btn-success" onClick={this.validate}>
                Next
              </a>
            </div>
            <div>
              <p>
                Use NumPad 1,NumPad 2,Numpad 3 to choose option and press enter
                to submit
              </p>
            </div>
          </div>
